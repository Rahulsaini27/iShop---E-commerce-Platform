...
const MainContext = (props) => {
    ...
    const fetchProduct = useCallback((limit = 0, color_id = null, category_slug = null) => {
    ...
    }, [API_BASE_URL, CATEGORY_BASE_URL]);
    ...
    useEffect(() => {
        ...
        fetchColor();
        fetchProduct();
    }, [fetchCategory, fetchColor, fetchProduct]);
