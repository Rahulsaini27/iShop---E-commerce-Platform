...
const Signup = () => {
    ...
    const handlePasswordChange = (e) => {
        ...
        if (password.length < 6) {
            ...
            setPasswordColor('text-red-500'); // Change color to red
            
        } else if (password.length < 10) {
            setPasswordStrength('Password is moderate');
            setPasswordColor('text-yellow-500'); // Change color to yellow
        } else {
            setPasswordStrength('Password is strong');
            setPasswordColor('text-green-500'); // Change color to green
        }
    }
            ...
            <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <p className="text-sm font-medium text-gray-900 my-8">
                        You have an account <Link to={'/login'} className='font-semibold text-indigo-600'>Login In</Link>
                    </p>
                </div>
            </div>
        </div>
