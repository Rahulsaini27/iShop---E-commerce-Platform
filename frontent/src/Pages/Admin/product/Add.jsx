                ...
                <form onSubmit={formSubmitHandler} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <div className='grid grid-cols-2 gap-8'>
                        <div className="mb-4">
                            ...
                            <input name='name' onChange={titleToslug} ref={nameRef} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name" type="text" placeholder="Product Name" />
                        </div>
                        <div className="mb-4">
                            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="slug">Product Slug</label>
                            <input name="slug" ref={slugRef} readOnly className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="slug" type="text" placeholder="Product Slug" />
                        </div>
                    </div>
                    <div className='grid grid-cols-3 gap-8'>
                        <div className="mb-4">
                            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="price">Price</label>
                            <input onChange={calDiscount} ref={priceRef} min={0} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="price" type="number" placeholder="Price" />
                        </div>
                        <div className="mb-4">
                            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="discount">Discount %</label>
                            <input onChange={calDiscount} defaultValue={0} min={0} max={99} ref={discountRef} name='discount' className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="discount" type="number" placeholder=" Enter Discount %" />
                        </div>
                        <div className="mb-4">
                            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="final_price">Final Price</label>
                            <input onChange={calDiscount} ref={finalRef} readOnly name='final_price' className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="final_price" type="number" placeholder="Final Price" />
                        </div>
                    </div>
                    <div className='grid grid-cols-2 gap-8'>
                        <div className="mb-4">
                            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="category">Category</label>
                            <Select onChange={(option) => { setProdCategory(option.value) }} className="basic-single" classNamePrefix="select" isSearchable={true} name="category" options={CategoryOptions} />
                        </div>
                        <div className="mb-4">
                            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="color">Color</label>
                            <Select onChange={(options) => { const d = options.map((option) => option.value); setProdColor(d); }} className="basic-single" classNamePrefix="select" isSearchable={true} components={animatedComponents} name="color" isMulti options={ColorOptions} />
                        </div>
                    </div>
                    <div className="mb-4">
